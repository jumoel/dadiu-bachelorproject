...
formål for eksempel var at samle mønter op eller få den hurtigste
tid. Desuden ville instruktøren gerne have et 'sprogløst' spil, så
vi undgik tekst og tale. For eksempel startes spillet ved at trykke på
Sophie i menuen (figur \ref{fig:sopmenu}). Lyden fjernes fra spillet
ved at trykke på den hoppende radio. I \emph{tutorial}-banen vises
styringsmetoden derfor også med video i stedet for ved hjælp af tale
eller tekst (figur \ref{fig:soptut}).
...
Idéen til spillet blev fundet ved hjælp af kollektiv brainstorming
over den første halvanden dag i forløbet. Vi havde tre primære idéer,
hvoraf 'Jorden er giftig'-temaet blev valgt som vores foretrukne på
den anden dag af produktionen.
...
Endvidere blev hele forløbet inddelt i en række \emph{sprints} af tre
eller fire dage. Hver deltager vurderede så i starten af en
\emph{sprint}, hvor meget arbejde de regnede med at kunne få fra hånden
...
sværere på grund af kodens lave kvalitet. Når kildekoden blev mere
kringlet medførte det også, at det stort set kun var den oprindelige
programmør, der til slut kunne gennemskue, hvor ændringer skulle
foretages. Det gjorde, at de forskellige programmører fik meget skarpt
opdelte roller: lyd, animation, kunstig intelligens, og så videre.
...
spillet. På produktionen var der dog reelt kun tre
fuldtidsprogrammører, hvilket betød at jeg var nødt til også at bruge
en del tid på forefaldende programmerings- og
implementeringsopgaver. Blandt disse kan nævnes:
...
\item Finpudsning af baner i forhold til den kunstige intelligens' opførsel
...
optaget\footnote{Det vil sige børnenes musebevægelser og vej igennem spillet,
  men altså ikke børnenes reaktioner og lignende}, samtidig med at vores
...
at finpudse sværhedsgrad og lignende.
...
der lå lige over hinanden. Det vil sige for ethvert
$(x,~z)$-koordinat, måtte der kun være et gangbart punkt. Var der
alligevel flere, ville den kunstige intelligens ikke være opmærksom på
andre overflader end den, der stod øverst i Unitys scenehierarki.
...
kan flyttes, væltes, destrueres og lignende), implementerede vi også
...
fejlberegninger, uventede forhindringer og lignende, teleporterede vi KI'en
...
intelligens bliver blot flyttet langs en \emph{bezier}-kurve som er
lavet mellem start- og slut-punktet for hoppet.
...
(figur \ref{fig:sopevilbear}). Fjenderne vandrer rundt på en platform
og vender om i en vilkårlig retning, hvis de finder ud, af at der er en
kant foran dem. Når fjenderne ser spilleren, begynder de at opbygge
vrede, hvorefter de løber imod spilleren og forsøger at skubbe hende ud
over kanten.
...
\fig[\textwidth]{contents/dreamleap/sophie_syre.png}{Jorden er blevet
  giftig. KI'en (øvre venstre hjørne) hopper igennem
  banen.}{fig:sopaiingame}

\fig[\textwidth]{contents/dreamleap/sophie_bjoern.png}{Fjenderne i
  \sop}{fig:sopevilbear}
...
bane var i Unity for eksempel ti meter bredt og ti meter langt, og
vores hovedpersoner er omkring tre og seks meter høje. Det gjorde at
...
bekendte med ømme punkter i spillet.
