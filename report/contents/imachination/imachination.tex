...
maskiner. I figur \ref{fig:imaProgress} ses spillerens progression
...
Maskinen kører fremad når man holder venstre museknap nede. Maskinen
roterer hele tiden for at holde fronten mod musen. Det er muligt at
trykke på sig selv og derved affyre et \emph{repulsor}-våben, som
skubber fjender væk. Målet med spillet er at positionere sig selv så
det er muligt at ødelægge de bygninger der befinder sig rundt i
banerne. Derefter skal man besejre bossen.  Begge dele naturligvis
uden at dø.  Alle banerne har form som sandkassen. Hvis man kigger
nøje efter, kan man se at mange af ikonerne til våben, fjender og
lignende kan findes i sandkassen. På figur \ref{fig:imaLevel} kan man
se en af banerne i spillet.
...
mere. Det er også et barn der har indtalt \emph{voice-over}
stemmen til vores trailer\citep{imatrailer} på engelsk, selvom han ikke
kunne tale sproget. Manuskriptet er blevet læst højt for ham og han er
...
\emph{project manager}, men udover det var der ikke meget koordinering
...
Unity har indbygget. Det blev ændret således at maskinen får tilføjet
en kraft i dens fremadretning. Det gjorde derimod at maskinen beholdte
en kraft i en retning, selvom den drejer, hvilket får den til at
...
opdrift maskinen kunne få, så sammenstød med bosser o.l. ikke fik den
til at flyve.
...
ses i figur \ref{fig:imaSteering}, omkring maskinen, der skal fortælle
spilleren hvordan den vende samt hvilken retning den forsøger at dreje
imod.
...
internettet. Implementeringen havde både A*-\emph{pathfinding} samt et
modul med et nemt brugerinterface til at generere et
navigationsgitter. Desværre var det ikke helt så smertefrit at
implementere dette som først antaget. Vi fik nogle ydelsesproblemer,
da vi i spillets tredje bane har 50 små fjender som jagter spilleren
på en gang. Derfor måtte dele af koden omskrives for at bruge mindre
ressourcer. Det var hovedsageligt selve styringen/flytningen af
enheder der tog mange kræfter. Det resulterede i, at vi var nødt til
at udskifte Unitys indbyggede funktionalitet til at flytte
objekter. Det blev erstattet af en ren kraftbaseret udgave, der betød
at vi mistede Unitys kollissionsdetektering, hvilket betød fjenderne
kunne gå igennem terrænet. Derfor bliver de hele tiden flyttet, så de
altid er ovenpå terrænet. % Sætningen er i O(1)
...
opføre sig naturligt uden at introducere nye problemer: Fx ville
...
små fjender dør ekstremt let, er det en mere tilfredsstillende at få
